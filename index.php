...
?>    
    ...
    <footer>
        <div class="d-flex justify-content-center align-items-center m-1">
            <h3 class="text-center m-0">This project came to life thanks to <a class="credit" href="https://developers.themoviedb.org/3/getting-started/introduction" target="_blank"><img src="https://www.themoviedb.org/assets/2/v4/logos/v2/blue_short-8e7b30f73a4020692ccca9c88bafe5dcb6f8a62a4c6bc55cd9ba82bb2cd95f6c.svg"></a> , <a href="https://github.com/cavestri/themoviedb-javascript-library" target="_blank">its js wrapper</a>, <a href="https://selectize.dev/" target="_blank">Selectize</a>, <a href="https://lokeshdhakar.com/projects/color-thief/" target="_blank">Color Thief</a>, and <a href="https://fabricelejeune.github.io/jquery-duotone/" target="_blank">jquery-duotone</a> as in our implementation of php, mysql, and <a class="credit" href="https://developers.themoviedb.org/3/getting-started/introduction" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Firebase_Logo.svg/1200px-Firebase_Logo.svg.png"></a></h3>
        </div>
    </footer>
</body>
